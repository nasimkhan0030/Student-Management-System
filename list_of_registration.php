                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data_list[$class] ?></td>
                                                        <td>
                                                            <a href="edit_registration.php?id=<?php echo $admision_id ?>" class="btn btn-success">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <a href="delete_registration.php?id=<?php echo $admision_id ?>" class="btn btn-danger mx-3">
