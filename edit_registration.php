...
?>
    ...
    if (isset($_GET['roll'])) {
        ...
        if ($conn->query($sql1) == TRUE) {
            header('location:list_of_registration.php');
        } else {
            echo "Error occur.";
        }
    }
                                    ...
                                    <div class="card-body">
                                        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="GET">
                                            <div class="form-group">
                                                <label for="exampleInputClass">Assign Class Roll</label>
                                                <input type="text" name="roll" class="form-control" id="exampleInputClass" aria-describedby="emailHelp"
